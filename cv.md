...
**AI & LLM Tooling**
MCP (Model Context Protocol) server development, Claude API integrations, autonomous agent system design and operation

**Embedded & IoT**
ESPHome, Arduino, ESP32, I²C / Two-Wire protocols, custom component development in C++

**DevOps & Infrastructure**
Docker, Linux system administration, Unraid NAS/server management, Proxmox virtualisation, Samba AD-DC, NodeRed, Google Workspace administration
...
Selected repositories at [github.com/Carltk](https://github.com/Carltk):
...
- **[TwoWireViewer](https://github.com/Carltk/TwoWireViewer)** — VB6 I²C/Two-Wire bus diagnostic and monitoring tool for embedded hardware development.

---

## Education

**Electronics Engineering Certificate** — Credit Grade
**Higher School Certificate** — 80–85th percentile
